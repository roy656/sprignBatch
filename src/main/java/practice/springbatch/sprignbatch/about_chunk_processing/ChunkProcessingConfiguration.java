package practice.springbatch.sprignbatch.about_chunk_processing;
...
public class ChunkProcessingConfiguration {
    ...
    public Step chunkBaseStep() {
        return stepBuilderFactory.get("chunkBaseStep")
                .<String, String>chunk(25)  // 제네릭 첫번째 String 은 reader 에서 반환되는 input, 두번째 String 은 processor 에서 반환되는 output.
